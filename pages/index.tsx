    ...
    <ChakraProvider>
      <div style={{ backgroundColor: '#ADD8E6' }} className="min-h-screen">
        ...
        <Flex minH="100vh" align="center" justify="center" p={8} flexDirection={{ base: 'column', md: 'row' }}>
          ...
          <Image src="logo.jpg" alt="Your Logo" mb={4} mx="auto" boxSize="100px" />
            ...
            <form>
              ...
              <Box textAlign="center" mt={2}>
                ...
                <Button variant="outline" size="lg" w="100%" mb={2} colorScheme="red">
          ...
          <VStack align="center" maxW="400px" ml={{ base: 0, md: 8 }}>
            ...
            <Image src="logo.jpg" alt="Your Logo" mb={4} mx="auto" boxSize="100px" borderRadius="full" />
